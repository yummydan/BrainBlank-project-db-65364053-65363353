...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (username) {
        ...
        // กำหนดข้อความต้อนรับพร้อมใช้ <strong> เพื่อให้ username เป็นตัวหนา และเพิ่ม <br> สำหรับขึ้นบรรทัดใหม่
        welcomeMessage.innerHTML = `Hello, <strong>${username}</strong>!<br>Welcome to your page.`;
